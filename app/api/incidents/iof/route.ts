  ...
  try {
    ...
    return NextResponse.json({
      ...
      record: {
        ...
        severityLevel,
        site,
        securityLead: body.securityLead || 'Biswajit Naskar',
        exactLocation,
        description,
        ...
        shiftIcSignature: body.shiftIcSignature || "Biswajit Naskar",
        fmLeadSignature: body.fmLeadSignature || "Biswajit Naskar",
